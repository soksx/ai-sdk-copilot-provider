...
export async function completeOAuthFlow(
  ...
  onStatusChange?.("pending", `Visit ${deviceCode.verificationUri} and enter code: ${deviceCode.userCode}`)

  const result = await pollForAccessToken(deviceCode.deviceCode, deviceCode.interval, deviceCode.enterpriseUrl, onStatusChange)
